...
{
    public class CreateAccountCommand : BaseRequest<AccountRespDto>
    {
        public AccountReqDto Dto { get; set; }

        public class CreateAccountCommandHandler : BaseRequestHandler<CreateAccountCommand, AccountRespDto>
        {
            private readonly IMapper _mapper;
            private readonly ISender _sender;

            public CreateAccountCommandHandler(IAwesomeGICBankDBContext context
                , IMapper mapper
            ...
            public override async Task<AccountRespDto> Handle(CreateAccountCommand request
